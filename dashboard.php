...
<head>
	...
	<title>Resello  | Admin Dashboard</title>
...
?>
													<div class="stat-panel-number h1 "><?php echo mysqli_num_rows($query);?></div>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-success text-light">
												<div class="stat-panel text-center">
												<?php 
$sql1 ="SELECT `Lid` from `sellings`; ";
$query1 = mysqli_query($conn,$sql1)
/*$query1->execute();
$results1=$query1->fetchAll(PDO::FETCH_OBJ);
$totalvehicle=$query1->rowCount();*/
?>
													<div class="stat-panel-number h1 "><?php echo mysqli_num_rows($query1) ;?></div>
													<div class="stat-panel-title text-uppercase">Listed Sellings</div>
												</div>
											</div>
					...
					<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-info text-light">
												<div class="stat-panel text-center">
<?php 
$sql5 ="SELECT `cid` from `complaints` ";
...
?>
													...
													<div class="stat-panel-number h1 "><?php echo mysqli_num_rows($query5)	;?></div>
